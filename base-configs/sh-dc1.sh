...
#
# DC1 SINGLE-HOMED client emulator (eth1 -> leaf3 access port).
...
# L2-DCI single-homed logical client
make_client sh1-l2 eth1.100 00:00:00:00:01:13 10.100.0.13/24
# L3-DCI single-homed logical client
make_client sh1-l3 eth1.200 00:00:00:00:02:13 10.200.1.13/24 10.200.1.254
# L2-DCI BD-B single-homed logical client (2nd stretched bridge-domain)
make_client sh1-l2b eth1.110 00:00:00:00:0b:13 10.110.0.13/24

echo "sh-dc1 client emulation ready"
