...
#
# DC2 MULTI-HOMED client emulator.
# eth1 -> leaf5, eth2 -> leaf6 bonded (802.3ad/LACP) into bond0; leaf5+leaf6 form one
# EVPN all-active Ethernet-Segment. Two logical clients per service via macvlan+netns.
#
...
make_client mh2-l2a bond0.100 00:00:00:00:01:21 10.100.0.21/24
make_client mh2-l2b bond0.100 00:00:00:00:01:22 10.100.0.22/24
# L3-DCI logical clients (2x multi-homed) - DC2 subnet
make_client mh2-l3a bond0.200 00:00:00:00:02:21 10.200.2.21/24 10.200.2.254
make_client mh2-l3b bond0.200 00:00:00:00:02:22 10.200.2.22/24 10.200.2.254
# L2-DCI BD-B logical clients (2x multi-homed) - 2nd stretched bridge-domain, prefers dcgw4
make_client mh2-l2c bond0.110 00:00:00:00:0b:21 10.110.0.21/24
make_client mh2-l2d bond0.110 00:00:00:00:0b:22 10.110.0.22/24

echo "mh-dc2 client emulation ready"
